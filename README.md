...
**Todo List**  is a website that helps you plan your day. You can add, delete and mark tasks as complete. This application will be built using React.
...
```sh
  cd my-folder
  git clone git@github.com:forLoop94/todo-list_react.git
  npm install
```
...
- [ ] **Drag and drop selected tasks in order of priority**
